...
var CacheMap = Object; // WeakMap (ES6) might be better
...
Image.prototype.invoke = function(method, object, args) {
    var context = new Context();
    var frame   = new Invocation();

    this.ves_exec_method_with_context(frame, context);
};

Image.prototype.ves_exec_method_with_context = function(method, object, args) {
