...
I.prototype.metadata_interface_from_typedef_full= function(idx, heap_allc_result, context) {
...
I.prototype.format_guid = function(binary) {
...
I.prototype.class_create_from_typedef = function(type_token, context) {
...
I.prototype.get_method_full = function(token, klass, context) {
...
I.prototype.run = function(args) { // ves_exec()@interpreter/interp.c
