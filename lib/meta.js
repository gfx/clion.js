...
var C = {
    ...
    ASSEMBLYREF_SIZE                              : 9,
    ASSEMBLYREF_RETARGETABLE_FLAG                 : 256,
    ASSEMBLYREF_DISABLEJITCOMPILE_OPTIMIZER_FLAG  : 16384,
    ASSEMBLYREF_ENABLEJITCOMPILE_TRACKING_FLAG    : 32768,
    ...
    EVENT_TYPE                                    : 2,
    EVENT_SIZE                                    : 3,
    EVENT_SPECIALNAME                             : 512,
    EVENT_RTSPECIALNAME                           : 1024,
    ...
    MANIFEST_OFFSET                               : 0,
    MANIFEST_RESOURCE_PUBLIC                      : 1,
    MANIFEST_FLAGS                                : 1,
    MANIFEST_RESOURCE_PRIVATE                     : 2,
    MANIFEST_NAME                                 : 2,
    MANIFEST_IMPLEMENTATION                       : 3,
    MANIFEST_SIZE                                 : 4,
    MANIFEST_RESOURCE_VISIBILITY_MASK             : 7,
    MARSHAL_CONV_NONE                             : 0,
    ...
    METHOD_IMPL_ATTRIBUTE_AGGRESSIVE_INLINING     : 256,
    ...
    PARAM_ATTRIBUTE_IN                            : 1,
    PARAM_SEQUENCE                                : 1,
    PARAM_NAME                                    : 2,
    PARAM_ATTRIBUTE_OUT                           : 2,
    PARAM_SIZE                                    : 3,
    PARAM_ATTRIBUTE_OPTIONAL                      : 16,
    PARAM_ATTRIBUTE_HAS_DEFAULT                   : 4096,
    PARAM_ATTRIBUTE_HAS_FIELD_MARSHAL             : 8192,
    PARAM_ATTRIBUTE_UNUSED                        : 53216,
    PARAM_ATTRIBUTE_RESERVED_MASK                 : 61440,
    PARSE_TYPE                                    : 0,
    PARSE_MOD_TYPE                                : 1,
    PARSE_LOCAL                                   : 2,
    PARSE_PARAM                                   : 3,
    PARSE_RET                                     : 4,
    PARSE_FIELD                                   : 5,
    PINVOKE_ATTRIBUTE_CHAR_SET_NOT_SPEC           : 0,
    PINVOKE_ATTRIBUTE_NO_MANGLE                   : 1,
    PINVOKE_ATTRIBUTE_CHAR_SET_ANSI               : 2,
    PINVOKE_ATTRIBUTE_CHAR_SET_UNICODE            : 4,
    PINVOKE_ATTRIBUTE_CHAR_SET_MASK               : 6,
    PINVOKE_ATTRIBUTE_CHAR_SET_AUTO               : 6,
    PINVOKE_ATTRIBUTE_CALL_CONV_GENERICINST       : 10,
    PINVOKE_ATTRIBUTE_CALL_CONV_GENERIC           : 16,
    PINVOKE_ATTRIBUTE_BEST_FIT_ENABLED            : 16,
    PINVOKE_ATTRIBUTE_BEST_FIT_DISABLED           : 32,
    PINVOKE_ATTRIBUTE_BEST_FIT_MASK               : 48,
    PINVOKE_ATTRIBUTE_SUPPORTS_LAST_ERROR         : 64,
    PINVOKE_ATTRIBUTE_CALL_CONV_WINAPI            : 256,
    PINVOKE_ATTRIBUTE_CALL_CONV_CDECL             : 512,
    PINVOKE_ATTRIBUTE_CALL_CONV_STDCALL           : 768,
    PINVOKE_ATTRIBUTE_CALL_CONV_THISCALL          : 1024,
    PINVOKE_ATTRIBUTE_CALL_CONV_FASTCALL          : 1280,
    PINVOKE_ATTRIBUTE_CALL_CONV_MASK              : 1792,
    PINVOKE_ATTRIBUTE_THROW_ON_UNMAPPABLE_ENABLED : 4096,
    PINVOKE_ATTRIBUTE_THROW_ON_UNMAPPABLE_DISABLED: 8192,
    PINVOKE_ATTRIBUTE_THROW_ON_UNMAPPABLE_MASK    : 12288,
    ...
    PROPERTY_MAP_SIZE                             : 2,
    PROPERTY_SIZE                                 : 3,
    PROPERTY_ATTRIBUTE_SPECIAL_NAME               : 512,
    PROPERTY_ATTRIBUTE_RT_SPECIAL_NAME            : 1024,
    PROPERTY_ATTRIBUTE_HAS_DEFAULT                : 4096,
    PROPERTY_ATTRIBUTE_UNUSED                     : 59903,
    PROPERTY_ATTRIBUTE_RESERVED_MASK              : 62464,
    ...
    TYPE_I4                                       : 8,
    TYPE_ATTRIBUTE_SEQUENTIAL_LAYOUT              : 8,
    TYPE_U4                                       : 9,
    TYPE_I8                                       : 10,
    TYPE_U8                                       : 11,
    TYPE_R4                                       : 12,
    ...
    TYPE_PTR                                      : 15,
    TYPE_BYREF                                    : 16,
    TYPE_ATTRIBUTE_EXPLICIT_LAYOUT                : 16,
    TYPE_VALUETYPE                                : 17,
    TYPE_CLASS                                    : 18,
    TYPE_VAR                                      : 19,
    TYPE_ARRAY                                    : 20,
    ...
    TYPE_ATTRIBUTE_RT_SPECIAL_NAME                : 2048,
    TYPE_ATTRIBUTE_IMPORT                         : 4096,
    TYPE_ATTRIBUTE_SERIALIZABLE                   : 8192,
    TYPE_ATTRIBUTE_UNICODE_CLASS                  : 65536,
    TYPE_ATTRIBUTE_AUTO_CLASS                     : 131072,
    TYPE_ATTRIBUTE_STRING_FORMAT_MASK             : 196608,
    TYPE_ATTRIBUTE_HAS_SECURITY                   : 262144,
    TYPE_ATTRIBUTE_RESERVED_MASK                  : 264192,
    TYPE_ATTRIBUTE_BEFORE_FIELD_INIT              : 1048576,
    TYPE_ATTRIBUTE_FORWARDER                      : 2097152,
    TYPEDEF_FLAGS                                 : 0,
    TYPEDEF_NAME                                  : 1,
    TYPEDEF_NAMESPACE                             : 2,
    TYPEDEF_EXTENDS                               : 3,
